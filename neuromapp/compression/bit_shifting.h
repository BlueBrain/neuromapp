...
namespace neuromapp {
    ...
    void populate_block_by_parts( block<unsigned int,cstandard> & split_block,block<value_type,cstandard>& unsplit_block) {
    ...
    block<unsigned int, cstandard> generate_split_block(block<value_type,cstandard> & unsplit_block) {
        ...
        populate_block_by_parts(split_block,unsplit_block);
        return split_block;
    }
}
