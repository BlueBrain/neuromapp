...
void nest_event_passing_content(po::variables_map const& vm){
    ...
    std::string syn_model = vm["syn_model"].as<size_t>();
    double syn_delay = vm["syn_delay"].as<double>();
    double syn_weight = vm["syn_weight"].as<double>();
    double syn_U = vm["syn_U"].as<double>();
    double syn_u = vm["syn_u"].as<double>();
    double syn_x = vm["syn_x"].as<double>();
    double syn_tau_rec = vm["syn_tau_rec"].as<double>();
    double syn_tau_fac = vm["syn_tau_fac"].as<double>();
...
int nest_event_passing_execute(int argc, char* const argv[]){
    try {
